...
const JpgToPdfPage: React.FC = () => {
  ...
  const [pageBg, setPageBg] = useState<string>('#ffffff'); // visible on margins
  ...
  }, [orderMode, pageSizeKey, orientation, marginPreset, fitMode, jpegQuality, pageBg]);
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      for (let idx = 0; idx < orderedFiles.length; idx++) {
        ...
        // Recompress JPEG via canvas to control quality (smaller PDFs)
        ...
        // Draw the original JPEG onto a canvas and export with target quality
        ...
        const jpegBlob: Blob = await new Promise((resolve) =>
          canvas.toBlob(
            resolve,
            'image/jpeg',
            Math.min(1, Math.max(0.1, jpegQuality / 100))
          )
        );
        const arr = await jpegBlob.arrayBuffer();
        const embedded = await pdfDoc.embedJpg(arr);
        ...
        // Paint page background (visible in margins)
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Convert multiple JPGs to a single PDF with page size, margins, orientation, ordering, and compression quality. Fast, private, free."
        />
          ...
          <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-8 mb-8 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Convert your JPG images to a single, high-quality PDF — with full control over size, layout, and compression.
              </p>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 mb-8">
            <div className="p-8">
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Drop your JPG files here</h3>

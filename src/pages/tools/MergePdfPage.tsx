...
const MergePdfPage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* ✅ Keep your existing Helmet settings */}
      <Helmet>
        <title>Merge PDF Files – Combine Multiple PDFs | FilesNova</title>
        <meta
          name="description"
          content="Join multiple PDF files into one. Drag and drop to merge PDFs instantly. Free, secure, and no watermarks with FilesNova."
        />
        <link rel="canonical" href="https://filesnova.com/tools/merge-pdf" />
      </Helmet>

      {/* ✅ Keep existing WebApplication JSON-LD */}
      <JsonLd
        data={{
        ...
        data={{
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://filesnova.com/' },
            {
              ...
              position: 2,
              name: 'Merge PDF',
              item: 'https://filesnova.com/tools/merge-pdf',
            },
          ],
        }}
      />

...
const GifToMp4Page: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>GIF to MP4 – Convert GIFs to MP4 Video | FilesNova</title>
        <meta
          name="description"
          content="Convert animated GIFs to MP4 video format quickly and easily. Free and secure online GIF-to-MP4 converter by FilesNova. No watermarks or signup required."
        />

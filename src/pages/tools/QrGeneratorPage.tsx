...
const QrGeneratorPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>QR Code Generator – Create QR Codes Online | FilesNova</title>
        <meta
          name="description"
          content="Generate QR codes instantly from text or URLs with our free online QR code generator."
        />
        <link rel="canonical" href="https://filesnova.com/tools/qr-code-generator" />
      </Helmet>

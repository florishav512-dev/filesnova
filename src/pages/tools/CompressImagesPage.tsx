...
/**
 * CompressImagesPage reduces the size of JPEG and PNG images while preserving
 * quality. Compressed images are packaged into a ZIP archive. This runs
 * entirely on the client using browser-image-compression.
 */
const CompressImagesPage: React.FC = () => {
  ...
  const [quality, setQuality] = useState(0.8); // range 0.1–1
  const [maxSizeMB, setMaxSizeMB] = useState(1); // MB threshold
...
<JsonLd data={"@context":"https://schema.org","@type":"WebApplication","name":"Compres\1 \2mages – Files Nova","url":"https://filesnova.com/tools/compress-image","applicationCategory":"FileConverter","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}} />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-10">
          <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-8 mb-8 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                Reduce file size without sacrificing much quality.
              </p>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 mb-8">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-gray-700 font-medium mb-1">Quality ({Math.round(quality * 100)}%)</label>
                <input
                  type="range"
                  min="10"
                  max="100"
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-1">Max Size (MB)</label>
                <input
                  type="number"
                  min="0.1"
                  max="5"

...
const ImageResizerPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Image Resizer – Resize Images Online | FilesNova</title>
        <meta
          name="description"
          content="Resize your images to custom dimensions for free. Online image resizer supports JPG, PNG and more. Fast, secure, and no watermark."
        />

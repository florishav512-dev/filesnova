...
const ImageResizerPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Image Resizer – Resize Images Online (PNG/JPG) | FilesNova</title>
        <meta
          name="description"
          content="Resize images to custom dimensions right in your browser. Fast, free, and secure—upload, preview, and download resized PNG/JPG files instantly."
        />

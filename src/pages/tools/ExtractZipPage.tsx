...
const ExtractZipPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Extract ZIP – Unzip Files Online | FilesNova</title>
        <meta
          name="description"
          content="Easily extract ZIP files online. Fast, secure, and free unzip tool by FilesNova. Works in your browser with no software install."
        />

...
const CreateZipPage: React.FC = () => {
  ...
  // download URL and errors then store the selected files. The UploadZone
  // component always passes back an array of File objects.
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 relative overflow-hidden pt-24">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 mb-8">
          ...
          {/* Use the reusable drag‑and‑drop upload component so the upload area
              matches the rest of the application. Accept any file types

...
/**
 * WebpConverterPage converts JPEG and PNG images to the modern WebP format
 * using the browser's canvas. The converted images are packaged into a ZIP
 * archive for download. This conversion runs entirely in your browser.
 */
const WebpConverterPage: React.FC = () => {
  ...
  const convert = async () => {
    ...
    try {
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        if (blob) {
          const name = f.name.replace(/\.(jpg|jpeg|png)$/i, '.webp');
          zip.file(name, blob);
        }
  ...
  return (
    <>
      <Helmet>
        <title>WebP Converter – Convert Images to WebP Format | FilesNova</title>
        <meta
          name="description"
          content="Convert JPEG and PNG images to the efficient WebP format quickly with our free online WebP converter."
        />
        <link rel="canonical" href="https://filesnova.com/tools/webp-converter" />
      </Helmet>
        ...
        <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-8 mb-8 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Convert your images to WebP for better compression.
            </p>

  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Convert PDF pages to JPG images in your browser. Free, fast, and secure—download all pages as a ZIP. No signup, no watermarks."
        />
        ...
        data={{
          ...
          itemListElement: [
            { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://filesnova.com/' },
            {
              ...
              position: 2,
              name: 'PDF to JPG',
              item: 'https://filesnova.com/tools/pdf-to-jpg',
            },
          ],
        }}
      />

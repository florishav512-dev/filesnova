...
const UnlockPdfPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Unlock PDF – Remove Password from PDF Files | FilesNova</title>
        <meta
          name="description"
          content="Remove password protection from your encrypted PDFs quickly by entering the correct password using our free unlock tool."
        />
        <link rel="canonical" href="https://filesnova.com/tools/unlock-pdf" />
      </Helmet>

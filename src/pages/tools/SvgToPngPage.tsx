...
const SvgToPngPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>SVG to PNG Converter – Convert SVG to PNG Online | FilesNova</title>
        <meta
          name="description"
          content="Convert your SVG graphics into PNG images quickly and securely with our free SVG to PNG converter."
        />
        <link rel="canonical" href="https://filesnova.com/tools/svg-to-png" />
      </Helmet>

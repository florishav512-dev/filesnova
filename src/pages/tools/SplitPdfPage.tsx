...
/**
 * SplitPdfPage splits a PDF file into individual pages and packages them into a
 * ZIP archive. Each page becomes its own PDF file. This runs completely
 * client‑side to ensure privacy.
 */
const SplitPdfPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Split PDF – Separate PDF Pages into Individual PDFs | FilesNova</title>
        <meta
          name="description"
          content="Split your PDF file into individual pages and download them separately using our free PDF splitter."
        />
        <link rel="canonical" href="https://filesnova.com/tools/split-pdf" />
      </Helmet>
        ...
        <div className="relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-8 mb-8 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Extract every page of your PDF into its own file.
            </p>

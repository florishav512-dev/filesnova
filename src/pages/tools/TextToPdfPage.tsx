...
const TextToPdfPage: React.FC = () => {
  ...
  /**
   * Convert the current text to a PDF. To keep the UI responsive this
   * function yields back to the event loop every few lines and always
   * cleans up the loading state in a finally block. If something goes
   * wrong during creation the error will be logged and the progress
   * indicator hidden.
   */

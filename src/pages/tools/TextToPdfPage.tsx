...
const TextToPdfPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Text to PDF Converter – Convert Text to PDF Online | FilesNova</title>
        <meta
          name="description"
          content="Transform plain text into a PDF document quickly and securely with our free Text to PDF converter."
        />
        <link rel="canonical" href="https://filesnova.com/tools/text-to-pdf" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-20 space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 font-medium">Text to PDF</p>
            </div>
          </div>
        </div>
      </header>

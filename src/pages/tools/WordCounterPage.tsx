...
const WordCounterPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Word Counter – Count Words, Characters & Lines | FilesNova</title>
        <meta
          name="description"
          content="Use our free word counter to calculate words, characters and lines in your text or uploaded file instantly."
        />
        <link rel="canonical" href="https://filesnova.com/tools/word-counter" />
      </Helmet>

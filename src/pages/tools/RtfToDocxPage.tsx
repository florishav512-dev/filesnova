...
const RtfToDocxPage: React.FC = () => {
  ...
  // handleFileChange is replaced by UploadZone onFilesSelected below
  ...
  return (
    <>
      <Helmet>
        <title>RTF to DOCX Converter – Convert RTF to Word Online | FilesNova</title>
        <meta
          name="description"
          content="Convert simple RTF documents into DOCX format quickly with our free online RTF to DOCX converter."
        />
        <link rel="canonical" href="https://filesnova.com/tools/rtf-to-docx" />
      </Helmet>

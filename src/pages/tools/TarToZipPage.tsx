...
const TarToZipPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>TAR to ZIP Converter – Convert TAR Archives to ZIP | FilesNova</title>
        <meta
          name="description"
          content="Convert your TAR archives to ZIP format quickly and securely using our free TAR to ZIP converter."
        />
        <link rel="canonical" href="https://filesnova.com/tools/tar-to-zip" />
      </Helmet>
